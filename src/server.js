...
export async function serve({
  ...
  // domain in Host, which is never one of our own hostnames. We only enforce it
  // when bound to loopback; binding beyond loopback (LAVISH_AXI_HOST) is a
  // documented opt-in to serve "anything that can reach it" (README "Network
  // binding"), where legitimate clients arrive with their own Host and an
  // allowlist would break them.
